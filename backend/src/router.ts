...
export function createRouter() {
  ...
  // CORS open for the dashboard. GET + POST because /api/snapshots/refresh is
  // an unauthenticated write endpoint consumed directly by the frontend.
  app.use(
    '/api/*',
    cors({
      origin: '*',
  ...
  app.route('/api/snapshots', refreshRoute);
